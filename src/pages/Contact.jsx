                        ...
                        <div className="contactBox">
                            <div className="row">
                                ...
                                <div className="col-md-9 col-9">
                                    <h3>Useful Links</h3>
                                    <div>Inquiry: <a href="mailto:info@modarchindia.com">info@modarchindia.com</a></div>
                                    <div>Careers: <a href="mailto:info@modarchindia.com">careers@modarchindia.com</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="contactBox">
                            <div className="row">
                                ...
                                <div className="col-md-9 col-9">
                                    ...
                                    <div><a href="tel:(+91) 1204206253">(+91) 1204206253</a></div>
                                    <div><a href="tel:(+91) 1204206600">(+91) 1204206600</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
